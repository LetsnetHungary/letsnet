<script type="text/javascript" src="../../_assets/_js/Products/main.js"></script>
    ...
    <div id="page-content-wrapper">
      <div id="page-content">
        ...
        <div class="row">
              ...
              <div class="panel-body">
                <div id="cat_btn_holder" class="category_btn_holder">
                  <div class="btn-group cat_button">
                    <button id="allproducts" type="button" class="btn btn-secondary">Minden termék</button>
                  </div>
                  
                  <div class="cat_button" style="float: right">
                    <button id="editproducts" type="button" class="btn btn-secondary">Szerkesztés</button>
                  </div>
                  <div class="btn-group cat_button">
          ...
          <div id="sidepanel" class="col-md-4 sidepanel">
            <div class="panel">
              <div class="panel-body">
                ...
                <div class="item_holder">
                  <div class="main_prop_holder">
                    <div class="input-group">
                        ...
                        <input id="prodid" style="display:none;" type="text" class="form-control prop_input" placeholder="Termékkód">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon addon-inside btn-primary">
                            <i class="glyph-icon icon-font"></i>
                        </span>
