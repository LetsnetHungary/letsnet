...
$(function() {
  ...
  function readFile(file) {
    ...
    reader.onload = function(e) {
        ...
        img.onload = function() {
          ...
          elem = $('<li class="prod_img_wrapper shaking"><img class="prod_img" src="' +
          dataurl + '"><img class="prod_img_close"></li>');
          $('#prod_img_holder').append(elem);
          $('#prod_img_holder').sortable('refresh')
        }
        img.src = text;
    }
  ...
  $('#prod_btn_modify').click(function() {
    if($(this).data('type') == 0) {
      ...
      $('#prod_carousel .prod_img').each(function(i) {
        elem = $('<li class="prod_img_wrapper shaking"><img class="prod_img" src="' +
      ...
      $('#prod_carousel').show();
      $('#prod_img_holder li').each(function(i) {
